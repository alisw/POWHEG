...
c     Check if QCD radiation allowed
c     TODO: if-clauses somewhere above to prevent calculation of res1,2
         if (flst_qcdqedrad(jb,1)) then
...
c     Check if QED radiation allowed
         if (flst_qcdqedrad(jb,2)) then
            if(flg_with_em) then
